...
_STRUCTURE_DIFF_SYSTEM_PROMPT = (
    ...
    "3. Заверши одной общей рекомендацией по документу: обновить эталоны, "
    "исправить/переименовать поля или уточнить у разработчика.\n"
    ...
    def _build_structure_diff_prompt(
        ...
        *,
        ...
        lines.append(
            ...
            "отдельно): в чём суть расхождений с эталонами и одна общая рекомендация. "
